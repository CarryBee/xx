<template>
  <div class="order-list">
    <order-list-item v-for="(item, index) in orderList" :item="item"></order-list-item>
      <!--<div :key="index">-->
  ...
  data () {
    return {
      orderList: [{
        ...
        snap: [
          {
            id: '5b27dc5218b4ff184d833d82', // 商品快照的id
            title: '通付v1 通刷返现', // 商品标题
            text: 'text', // 商品文字描述
